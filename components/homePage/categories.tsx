...
export default function Categories(){
  ...
  return(
    <div className="bg-background w-full lg:pt-32 pt-20 lg:px-20 px-4 flex justify-center" >
      <div className='max-w-[1500px] w-full flex justify-center items-center flex-col'>
        ...
        <div className="grid grid-cols-4 grid-rows-4  gap-4 w-full md:grid-rows-3 lg:grid-rows-2"  >
          ...
          <div className={[classes.gridBox, "row-start-2 row-end-3 col-start-1 col-end-5",
            "md:col-end-3",
            "lg:row-start-1 lg:row-end-2 lg:col-start-3 lg:col-end-5 lg:h-80"].join(" ")} >
          ...
          <div className={[classes.gridBox, "row-start-3 row-end-4 col-start-1 col-end-5",
            ...
            "lg:row-start-2 lg:row-end-3 lg:col-start-3 lg:col-end-4 lg:h-80"].join(" ")} >
          ...
          <div className={[classes.gridBox, "row-start-4 row-end-5 col-start-1 col-end-5",
            "md:row-start-3",
            "lg:row-start-2 lg:row-end-3 lg:col-start-4 lg:col-end-5 lg:h-80"].join(" ")} >
            {BuyNowDiv("zapatos")}
